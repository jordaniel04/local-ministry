...
export function EnrollmentManager() {
  ...
  const { data: enrollments } = useLocalEnrollments()
  ...
  const currentAttempts = (attempts ?? []).filter((attempt) => attempt.status === 'in_progress')
